...
public class GameCenterClient implements IGameServiceClient {
	...
	public void showLeaderboards(String leaderBoardId) throws GameServiceException {
		...
		if (leaderBoardId != null)
			gameCenterView = new GKGameCenterViewController(leaderBoardId);
		else
			gameCenterView = new GKGameCenterViewController(GKGameCenterViewControllerState.Leaderboards);
	...
	public void showAchievements() throws GameServiceException {
		...
		GKGameCenterViewController gameCenterView = new GKGameCenterViewController(GKGameCenterViewControllerState.Achievements);
		gameCenterView.setGameCenterDelegate(new GKGameCenterControllerDelegateAdapter() {
			@Override
			public void didFinish(GKGameCenterViewController gameCenterViewController) {
				gameCenterViewController.dismissViewController(true, null);
	...
	public boolean submitToLeaderboard(String leaderboardId, long score, String tag) {
		if (isSessionActive() && leaderboardId != null) {
			GKLeaderboard.submitScore(score, 0, GKLocalPlayer.getLocal(), new NSArray<>(new NSString(leaderboardId)),
					error -> {
						// ignore errors
						if(error != null) {
							Gdx.app.error("ncgame", "Error submitting score" + error.getLocalizedDescription());
						}
					});
			return true;
		}
