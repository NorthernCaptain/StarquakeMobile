...
public abstract class FBO
{
    ...
    public void updateFBO(Batch batch)
    {
        needUpdate = false;
    ...
    public abstract void drawOnFBO(Batch fboBatch, float parentAlpha);

    public void prepareUpdateFBO()
    {
    ...
    public void finishUpdateFBO()
    {
        fboBatch.setBlendFunction(GL20.GL_SRC_ALPHA, GL20.GL_ONE_MINUS_SRC_ALPHA);
    }

    public TextureRegion getFboTextureRegion()
    {
        return fboTextureRegion;
    }
}
